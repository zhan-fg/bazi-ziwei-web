    ...
    <main className="flex-1 max-w-2xl mx-auto px-4 py-12 w-full">
      ...
      <div className="prose prose-stone max-w-none text-sm leading-relaxed space-y-6">
        <section>
          ...
          <p>All content provided by this Service — including Bazi charts, Ziwei Doushu charts, AI-generated readings, and poster designs — is intended for <strong>entertainment and cultural education purposes only</strong>. It does not constitute professional advice of any kind.</p>
        </section>
        ...
        <section>
          <h2 className="text-base font-semibold text-stone-800">AI-Generated Content</h2>
          <p>Our AI readings are generated by large language models trained on general knowledge. They may contain inaccuracies, inconsistencies, or content that does not reflect the views of the website operators. AI-generated content should be treated as entertainment output, not authoritative analysis.</p>
        </section>
