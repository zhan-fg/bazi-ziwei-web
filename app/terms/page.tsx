    ...
    <main className="flex-1 max-w-2xl mx-auto px-4 py-12 w-full">
      ...
      <div className="prose prose-stone max-w-none text-sm leading-relaxed space-y-6">
        ...
        <section>
          ...
          <p>This website provides automated Chinese astrology (Bazi and Ziwei Doushu) chart generation and AI-powered readings based on user-provided birth information. Charts are generated algorithmically. AI readings are generated by language models and reflect probabilistic interpretations of traditional metaphysical frameworks.</p>
        </section>
        ...
        <section>
          ...
          <p>Chart generation is free. AI-powered readings are offered as one-time purchases. All prices are in USD and include applicable taxes where required. Payments are processed securely through Stripe. By making a purchase, you agree to Stripe's terms of service.</p>
        </section>
